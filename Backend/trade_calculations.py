...
def get_trade_balance(cards_player: list, cards_opponent: list) -> int:
    ...
    print(f"both these cards cost {elixir_spent_player} elixir")
    ...
    print(f"both these cards cost {elixir_spent_opponent} elixir")
...
def get_trade_outcome(trade_balance: int) -> str: 
    if trade_balance > 0:
        return "positive"
    if trade_balance < 0: 
        return "negative"
